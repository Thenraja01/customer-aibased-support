          ...
          >
            {tenantLogo ? (
              <img
                ...
                alt={tenantName}
                className={cn(
                  "h-9 w-9 rounded-xl object-cover ring-2 ring-border/50 transition-all duration-300 group-hover:ring-indigo-500/30",
                  collapsed && "group-hover:scale-105"
                )}
              />
            ) : (
              <div className={cn(
                "h-9 w-9 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-indigo-500/20 transition-transform duration-300",
                collapsed && "group-hover:scale-105"
              )}>
                {tenantName.charAt(0)}
              </div>
            )}
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </div>
      ...
      <nav className="flex-1 overflow-y-auto overflow-x-hidden py-4 px-2 sidebar-scrollbar">
        {(() => {
          ...
          return Object.entries(grouped).map(([section, items], sectionIdx) => (
            <div key={section} className={cn("mb-2", sectionIdx !== 0 && "mt-4")}>
              {!collapsed && section !== "OTHER" && (
                <motion.div 
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="px-3 py-2 text-[10px] font-bold text-muted-foreground/50 uppercase flex items-center gap-2"
                >
                        ...
                        <TooltipPrimitive.Root>
                          <TooltipPrimitive.Trigger asChild>
                            <Button
                              variant="ghost"
                              className={cn(
                                "w-full justify-start transition-all duration-200 gap-3 relative overflow-hidden group",
                            ...
                            >
                              ...
                              {active && (
                                <motion.div
                                  ...
                                  className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-6 rounded-full bg-gradient-to-b from-indigo-500 to-purple-500"
                              ...
                              <div className={cn(
                                ...
                                active
                                  ? "bg-gradient-to-r from-indigo-500/8 via-indigo-500/5 to-transparent dark:from-indigo-950/30 dark:via-indigo-950/20"
                              ...
                              <div className={cn(
                                ...
                                active
                                  ? "bg-indigo-500/10 text-indigo-600 dark:bg-indigo-950/50 dark:text-indigo-400"
                              ...
                              {item.children.map((child) => {
                                ...
                                return (
                                  <Button
                                    ...
                                    variant="ghost"
                                    className={cn(
                                      "w-full justify-start text-[12.5px] transition-all duration-200 gap-3 h-9 px-3 relative group",
                                      childActive
                                        ? "text-indigo-600 dark:text-indigo-400 font-semibold"
                                  ...
                                  >
                                    {childActive && (
                                      <motion.div
                                        ...
                                        className="absolute left-0 top-1/2 -translate-y-1/2 w-[2px] h-4 rounded-full bg-indigo-400"
                                        transition={{ type: "spring", stiffness: 380, damping: 30 }}
                                      />
                                    )}
                                    <div className={cn(
          ...
          <div className="relative flex-1">
            ...
            >
              <div className="relative">
                <div className="h-9 w-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-semibold text-xs shadow-md shadow-indigo-500/20 ring-2 ring-background transition-transform duration-300 group-hover:scale-105">
                  {user?.name
                ...
                >
                  <div className="p-1.5 space-y-0.5">
                    <button
                      ...
                      className="w-full flex items-center gap-2.5 px-3 py-2 text-[13px] text-foreground rounded-lg hover:bg-indigo-500/10 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-200"
                    >

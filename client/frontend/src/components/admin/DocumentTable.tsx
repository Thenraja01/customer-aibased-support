  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        ...
        <tbody>
          {documents.map((doc) => (
            <tr key={doc._id} className="border-b dark:border-white/[0.06] hover:bg-muted/50 transition-colors">
              ...
              <td className="px-4 py-3 text-right">
                <div className="flex items-center justify-end gap-1">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => onView(doc)} title="View">
                    <Eye size={14} />
                  </Button>
                  <Button
                    variant="ghost"

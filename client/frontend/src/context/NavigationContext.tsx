...
export function getPathView(path: string): ActiveView | null {
  ...
  else if (path === "/chat-history") return "customer-chat-history";
  else if (path === "/chat") return "customer-chat";
  else if (path === "/tickets") return "customer-tickets";
  else if (path === "/faq") return "customer-faq";
  else if (path === "/notifications") return "customer-notifications";
  else if (path === "/documents") return "customer-documents";
  else if (path === "/profile") return "customer-profile";
  ...
  else if (path === "/superadmin/app-settings") return "superadmin-app-settings";
  ...
  else if (path === "/superadmin/profile") return "superadmin-app-settings";
  else if (path === "/superadmin/pending-org-admins") return "superadmin-pending-org-admins";
  else if (path === "/superadmin/communication") return "superadmin-communication";

  // Branch sync
  else if (path === "/branch/dashboard") return "branch-dashboard";
  else if (path === "/branch/documents") return "branch-documents";
  else if (path === "/branch/branches") return "branch-branches";

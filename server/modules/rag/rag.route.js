...
router.post("/ingest", restrict("admin", "agent"), validate(ingestSchema), ragController.ingest);
...
router.get("/graph/:documentId", restrict("admin", "agent"), ragController.getDocumentGraph);
router.get("/chunks/:documentId", restrict("admin", "agent"), ragController.getDocumentChunks);
router.get("/search", restrict("admin", "agent"), ragController.searchByKeyword);

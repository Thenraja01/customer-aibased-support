...
router.post("/store", restrict("super admin", "tenant admin", "admin", "agent"), validate(storeMemorySchema), memoryController.store);
...
router.patch("/:memoryId", restrict("super admin", "tenant admin", "admin", "agent"), validate(updateMemorySchema), memoryController.update);
router.delete("/:memoryId", restrict("super admin", "tenant admin", "admin", "agent"), memoryController.remove);

...
router.post("/store", restrict("admin", "agent"), validate(storeMemorySchema), memoryController.store);
...
router.patch("/:memoryId", restrict("admin", "agent"), validate(updateMemorySchema), memoryController.update);
router.delete("/:memoryId", restrict("admin", "agent"), memoryController.remove);

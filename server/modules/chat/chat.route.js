...
router.get("/", restrict("admin", "agent"), chatController.getChats);
router.get("/active", restrict("admin", "agent"), chatController.getActive);
router.get("/search", restrict("admin", "agent"), chatController.search);

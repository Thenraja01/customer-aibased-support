...
import { createVerificationSchema, approveVerificationSchema, rejectVerificationSchema } from "../../validation/index.js";
...
router.patch("/:id/approve", restrict("admin", "support"), validate(approveVerificationSchema), dvController.approve);

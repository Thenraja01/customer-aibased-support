...
router.get("/", restrict("super admin", "tenant admin", "admin", "agent"), orgController.getAll);
router.get("/search", restrict("super admin", "tenant admin", "admin", "agent"), orgController.search);
router.get("/:id", restrict("super admin", "tenant admin", "admin", "agent"), orgController.getById);
